    ...
    <div class="shell">
      <div class="admin-toolbar">
        ...
        <div class="admin-actions">
          <a class="back-btn" href="#admin-products" id="adminProductsBtn" data-admin-go="admin-products">${t('adminProducts')}</a><a class="back-btn" href="#admin-analytics" id="adminAnalyticsBtn" data-admin-go="admin-analytics">Statistik</a><a class="back-btn" href="#admin-customers" id="adminCustomersBtn" data-admin-go="admin-customers">Kunden</a><a class="back-btn" href="#admin-design" id="adminDesignBtn" data-admin-go="admin-design">${t('adminDesign')}</a>
          <a class="back-btn" href="#admin-orders" id="adminArchiveTabBtn" data-admin-archive-tab="1">Archiv</a><button class="back-btn" id="adminRefreshBtn">${t('adminRefresh')}</button>
...
function bindCommon(){
  ...
  document.querySelectorAll('[data-admin-go]').forEach(btn=>btn.onclick=(e)=>{
    ...
    state.route = route;
    if(route==='admin-products') loadAdminProducts();
    else if(route==='admin-design') loadAdminDesign();
    else if(route==='admin-analytics') loadAdminAnalytics();
    else if(route==='admin-customers') loadAdminCustomers();
    else render();
  });
